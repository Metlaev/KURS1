...
Сначала создал файл mergesort.py, вписал туда один текст, создал другую ветку, перешёл в неё, в ней заменил текст в созданном файле на другой, закоммитил это, перешёл в ветку master, опять же заменил данные из файла на иные и закоммитил изменения. Теперь мы видим, что HEAD указывает на последний коммит в этой ветке
# 5
![alt text](img/Снимок101.PNG)

Вижу все ветки и ту, в которой я нахожусь, то есть в master
# 6
![alt text](img/Снимок102.PNG)

Слил ветку Mergesort-Impl в ветку master, произошёл конфликт из-за различий в одинаковых строках в одном файле, решил его, выбрав текущие изменения
